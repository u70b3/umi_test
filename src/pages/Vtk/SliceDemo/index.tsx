    ...
    <div style={{ width: '100vw', height: '100vh' }}>
      <div style={{ width: '50vw', height: '100vh', display: 'inline-block' }}>
        ...
        >
          ...
          <Slider max={256} value={iSlice} setValue={setISlice} style={{ left: '5px' }} />
          <Slider max={256} value={jSlice} setValue={setJSlice} style={{ left: '155px' }} />
          <Slider max={95} value={kSlice} setValue={setKSlice} style={{ left: '305px' }} />
          <Slider
            max={4095}
            value={colorLevel}
          ...
          />
          <SliceRepresentation iSlice={iSlice} property={{ colorWindow, colorLevel }}>
            <ShareDataSet />
          </SliceRepresentation>
          <SliceRepresentation jSlice={jSlice} property={{ colorWindow, colorLevel }}>
            <ShareDataSet />
          </SliceRepresentation>
          <SliceRepresentation kSlice={kSlice} property={{ colorWindow, colorLevel }}>
            <ShareDataSet />
          </SliceRepresentation>
        </View>
      </div>
